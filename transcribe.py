...
apikey = 'aW9XaR2QdBXaU-1CoIkFmY0MAGSP7vYOwwoKNteS447y'
url = 'https://api.us-east.speech-to-text.watson.cloud.ibm.com/instances/d9146614-d219-4be1-a913-f6228fcfdb98'

authenticator = IAMAuthenticator(apikey)
stt=SpeechToTextV1(authenticator=authenticator)
stt.set_service_url(url)

apikeyT='cUlGDKQEZ4Wo6HpGdyfFn4buDEkDMKFvtyfMExqAmRTb'
urlT='https://api.eu-gb.text-to-speech.watson.cloud.ibm.com/instances/5f627b37-38ba-48b0-a58c-d193938696a3'

authenticatorT = IAMAuthenticator(apikeyT)
tts=TextToSpeechV1(authenticator=authenticatorT)
tts.set_service_url(urlT)
CHUNK = 1024
